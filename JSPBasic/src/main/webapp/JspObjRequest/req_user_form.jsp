...
<form action="req_user_info.jsp">
 	...
 	- PW: <input type="password" name="user_password" size="10px" /><br/>
 	
 	- 성별: <input type="radio" name="gender" value="남자"/> 남성 &nbsp;&nbsp;
           <input type="radio" name="gender" value="여자"/> 여성 <br/>
    
	- 취미: <input type="checkbox" name="hobbys" value="soccer"/>축구 &nbsp;
	       <input type="checkbox" name="hobbys" value="reading"/>독서 &nbsp;
	       <input type="checkbox" name="hobbys" value="rest"/>수면 &nbsp;
	       <input type="checkbox" name="hobbys" value="music"/>음악감상 <br/>
