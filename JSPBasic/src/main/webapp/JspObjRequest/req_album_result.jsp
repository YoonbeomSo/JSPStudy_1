...
<body>
	...
	<%
		if(title.equals("lovelyz4")) {
			response.sendRedirect("http://localhost:8181/JSPBasic/JspObjResponse/lovelyz4.jsp");
		}else if(title.equals("secret")){
			response.sendRedirect("../JspObjResponse/secret.jsp");
		}
	%>
	...
	<% if(title.equals("lovelyz4")) { %>
	 <div align="center">
		...
		<hr/>
		<h3>타이틀 곡 MV</h3>
		<!-- 자동재생: url주소 마지막에 ?rel=0;apm;autoplay=1 입력-->
