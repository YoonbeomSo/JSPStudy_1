...
<%	
	...
	if(application.getAttribute("complete_list") != null) {
		list = (List<String>)application.getAttribute("complete_list");//object로 return recast필요
	}
	
	//사용자가 예매를 희망하는 좌석정보가 들어있는 배열(이미 선점된 좌석 예약이 있어도 넘어옴)
	String[] seat = request.getParameterValues("seat");//다중선택이므로 Values 사용
