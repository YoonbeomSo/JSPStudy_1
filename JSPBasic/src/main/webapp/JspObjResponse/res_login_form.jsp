...
<%--
	*CSS(Cascade Style Sheet)
	...
	- CSS를 HTML에 적용하는 방식에는 3가지 방식이 있습니다.
 ...
 --%>
 <!-- div태그에 인라인 스타일 적용 -->
<div align="center" style="border: 2px solid blue; width: 80%; padding: 15px;" >
	<h3>sendRedirect 로그인 연습</h3> <hr/>
	<form action="res_login_ok.jsp" method="post">
		<table border="1">
			<tr>
				<td><input type="text" name="id" size="10px" placeholder="아이디"/></td>
				<td rowspan="2"><input class="login_btn" type="submit" value="로그인"/></td>
			</tr>
			<tr>
				<td><input type="password" name="pw" size="10px" placeholder="비밀번호"/></td>
			</tr>
		</table>
		</form>
</div>
